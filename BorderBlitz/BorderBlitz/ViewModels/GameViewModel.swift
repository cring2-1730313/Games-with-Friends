...
class GameViewModel: ObservableObject {
    ...
    private var countryPool: [Country] = []
    private var usedCountries: Set<String> = []
    private var roundTimer: Timer?
    private let scoringConfig = ScoringConfig()

    @Published var letterRevealManager: LetterRevealManager
    ...
    // MARK: - Initialization
    init() {
        self.letterRevealManager = LetterRevealManager(revealInterval: Difficulty.medium.letterRevealInterval)
        loadCountries()
    }
    ...
    func startGame() {
        ...
        letterRevealManager = LetterRevealManager(revealInterval: selectedDifficulty.letterRevealInterval)
    ...
    private func loadCountries() {
        countryPool = CountryDataProvider.getAllCountries()
    }
